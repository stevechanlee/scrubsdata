    ...
    public class AuthController : BaseApiController
    {
        ...
        public ActionResult<SuccessResponse> UpdatePassword(PasswordUpdateRequest model)
        {
            ...
            try
            {
                ...
                //twilio implementation for future versions; tested and working
                //const string accountSid = "AC9ce0258c40072c486755c2f20d4b73ef";
                //const string authToken = "8a7b9820c40a29c81734144aac4e8b1d";

                //TwilioClient.Init(accountSid, authToken);

                ////switch from trial phone to live upon publishing
                //string twilioPhone = "+16104223641";

                //var message = MessageResource.Create(
                //    body: "Thank you for resetting your Scrubs Data password." +
                //    " If you did not request this change, please go to our site" +
                //    " and click \"Forgot Password\" to secure your account.",
                //    from: new Twilio.Types.PhoneNumber(twilioPhone),
                //    //this 'to' phone number should be grabbed in the previous database queries
                //    to: new Twilio.Types.PhoneNumber("+18182057940")
                //);
